...
public class Kcp {
  ...
  private ReusableLinkedList<Segment> rcvQueue = new ReusableLinkedList<>();

  private ReusableLinkedList<Segment> sndBuf = new ReusableLinkedList<>();

  private ReusableLinkedList<Segment> rcvBuf = new ReusableLinkedList<>();

  private ReusableList<Segment> rcvQueueItr = rcvQueue.listIterator();

  private ReusableList<Segment> sndBufItr = sndBuf.listIterator();

  private ReusableList<Segment> rcvBufItr = rcvBuf.listIterator();
